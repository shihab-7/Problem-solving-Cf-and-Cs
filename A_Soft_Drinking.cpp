...
int main()
{
    ...
    int can_make = (k*l) / nl;
    int lime_quantity = c*d;
    int salt_quantity = p/np;
    int number_of_toast_possible = min(can_make,min(lime_quantity,salt_quantity))/n;
    cout<<number_of_toast_possible<<endl;
    return 0;
}